...
pthread_mutex_t komodo_mutex,LABS_mutex;
...
const uint32_t nStakedDecemberHardforkTimestamp = 1575574362;  //1576840000; //December 2019 hardfork 12/20/2019 @ 11:06am (UTC)
...
int32_t KOMODO_MININGTHREADS = -1,IS_KOMODO_NOTARY,IS_LABS_NOTARY,USE_EXTERNAL_PUBKEY,KOMODO_CHOSEN_ONE,ASSETCHAINS_SEED,KOMODO_ON_DEMAND,KOMODO_EXTERNAL_NOTARIES,KOMODO_PASSPORT_INITDONE,KOMODO_PAX,KOMODO_EXCHANGEWALLET,KOMODO_REWIND,LABS_ERA,KOMODO_CONNECTING = -1,KOMODO_DEALERNODE,KOMODO_EXTRASATOSHI,ASSETCHAINS_FOUNDERS,ASSETCHAINS_CBMATURITY,KOMODO_NSPV;
...
uint32_t ASSETCHAIN_INIT = 0,ASSETCHAINS_CC,KOMODO_STOPAT,KOMODO_DPOWCONFS = 1,STAKING_MIN_DIFF;
